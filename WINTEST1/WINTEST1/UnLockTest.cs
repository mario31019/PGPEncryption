...
namespace PGPTEST3
{
    ...
    {
        public void UnLockT(string decryptEncryptFileName, string keyFileName, char[] passwd, string defaultFileName)
        {
            Debug.WriteLine("START------UnLockTest-----------------------------------------------------------------");
            ...
            try
            {
                ...
                Debug.WriteLine("END---------UnLockTest--------------------------------------------------------------");
            }
            catch (Exception e)
            {
                MessageBox.Show("解密失敗" + e.Message);
            }
        }
            ...
            string defaultFileName)
        {
            ...
            try
            {
                ...
                if (o == null)
                {
                    Debug.WriteLine("檔案無法解密");
                    MessageBox.Show("檔案無法解密");
                }
                else {
